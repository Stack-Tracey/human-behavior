...
while game == 1:
    ...
    grün_rect = pygame.Rect(random.randint(0, ww - ball_grün.get_rect().width),
                            random.randint(0, wh - ball_grün.get_rect().height), ball_grün.get_rect().width,
                            ball_grün.get_rect().height)
    ...
    while x == 1:
        ...
        if pr_player == "true":
            ...
            a = math.sin(
                math.radians(angle_player)) * mvsp  # Brechnet die Länge der des angles gegenüberliegenden Seite.
        ...
        for i in range(len(bälle)):
            ...
            if bälle[i].top <= 0 or bälle[i].bottom >= wh:
                ...
                b = math.cos(
                    math.radians(angle_bälle[i])) * mvsp_bälle  # Berechnet die Länge der am angle anliegenden Kathete.
        ...
        if zeit_zaehler >= spawn_count:
            bälle.append(pygame.Rect(random.randint(0, ww - ball_rot.get_rect().width),
                                     random.randint(0, wh - ball_rot.get_rect().height), ball_rot.get_rect().width,
                                     ball_rot.get_rect().height))
